...
public class EmployeeAndTugrik extends EmployeeAndChild {
    ...
    //    public String getTugrikExchange() {
//        //double Tugrik = 8;
//        int paymentTugrik = (int) (getPayment() / TugrikExchange);
//        if (getPaymentType().equals("почасовая")) {
//            return getPaymentWithTax() + " / " + paymentTugrik;
//        } else {
...
//
    ...
    public String toString() {
        ...
        return String.format("%-8s | %-9s | %-10s  | %-10s  ", getFullName(), getTax(), getPayment(), Exchange(getPaymentType()));
